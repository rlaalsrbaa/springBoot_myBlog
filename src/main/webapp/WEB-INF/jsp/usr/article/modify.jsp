		...
		<form class="table-box-type-1" method="POST"
			...
			<table>
				...
				<tbody>
					...
					<tr>
						<th>조회</th>
						<td><span class="badge badge-primary">${article.hitCount}</span>
						</td>
					</tr>
					<tr>
						<th>추천</th>
						<td><span class="badge badge-primary">${article.extra__goodReactionPoint}</span>
						</td>
					</tr>
					<tr>
						<th>제목</th>
						<td><input class="w-96 input input-bordered" name="title"
							type="text" placeholder="제목" value="${article.title}" /></td>
					</tr>
					<tr>
						<th>내용</th>
